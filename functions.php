<?php
/**
 * CC Starter Theme functions and definitions
 *
...
if ( ! function_exists( 'CC_Starter_Theme_setup' ) ) :
	/**
	 ...
	 */
	function CC_Starter_Theme_setup() {
		/*
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'CC_Starter_Theme_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'CC_Starter_Theme_setup' );
 ...
 */
function CC_Starter_Theme_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'CC_Starter_Theme_content_width', 640 );
}
add_action( 'after_setup_theme', 'CC_Starter_Theme_content_width', 0 );
...
add_action( 'widgets_init', 'CC_Starter_Theme_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'CC_Starter_Theme_scripts' );
...
// Theme Settings Page built with ACF pro
